var messages = {
  ...
  var recognition;
  var langNoi='en-US';
  const langNoiEl=document.getElementById('langNoi');
  
  $( document ).ready(function() {
    if (!('webkitSpeechRecognition' in window)) {
      upgrade();
    } else {
        $("#langNoi").click(function () {
            if (langNoiEl.innerText==='en-US'){
                langNoiEl.innerText='vi-VN';
            }else{
                langNoiEl.innerText='en-US';
            }
            langNoi=langNoiEl.innerText;
            //alert(langNoi);
        });    
