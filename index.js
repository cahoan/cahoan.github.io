...
<textarea id="input-text" class="swal2-tien" placeholder="Nhập văn bản tiếng Việt" rows="6" cols="24" style="font-size:20px" color:darkgreen></textarea>
<textarea readonly id="translated-text" class="swal2-tien" placeholder="Bản dịch tiếng Anh sẽ hiển thị ở đây..." rows="6" cols="24" style="font-size:20px; color:orange;"></textarea>
<br>
...
<br>
    ...
    <textarea id="input-text" class="swal2-tien" placeholder="Enter English text" rows="6" cols="24" style="font-size:20px"></textarea>
      <textarea readonly id="translated-text" class="swal2-tien" placeholder="Vietnamese translation will display here..." rows="6" cols="24" style="font-size:20px;color:orange;"></textarea>
      <br>
      <button id="speak-button" class="swal2-confirm swal2-styled" style="display: none; margin-top: 10px; background:orange">🔊 Đọc</button>
      `,
showCancelButton: true,
...
lbbimatEl.addEventListener('click', function(event){
  ...
  Swal.fire({
    ...
    html: `
      <div id="hienbdQ" style="text-align: left;  color:orange;">`+qq+`</div>
      <div id="hienbdA" style="text-align: left;  color:green;">`+aa+`</div>
      `,
    confirmButtonText: "OK",
})
});
